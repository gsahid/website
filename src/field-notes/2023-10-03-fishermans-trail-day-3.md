---
title: "Fisherman's Trail, Day 3"
subtitle: "Almograve to Zambujeira do Mar (23 km)"
date: 2023-10-03
category: "Fisherman's Trail"
featuredImage: "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3447.jpg"
---

{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3399.jpg", "Morning view from Almograve" %}

Yesterday was just too good to be true: a short, easy stage. Pleasant interactions with other hikers. A hearty dinner with interesting conversations. What more could one ask for?

So of course to balance things out a little bit, the universe has decided that it's time to jazz things up a little bit.

{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3397.jpg", "Getting ready for the day" %}

Today started out with a hostel breakfast(!), which was arranged like a legit hotel breakfast. I was pleasantly surprised, because I thought they were going to give me a takeaway breakfast bag. But they opened up the buffet(!!) early at 7 upon my request, despite the receptionist telling me that they'd start serving breakfast at 8. I truly didn't deserve this. I couldn't stop saying _obrigada_ to the kind uncle who was in charge of the buffet. I was planning to go to the bakery but I decided to just take some more slices of the bolo and wrap them in tissues.

{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3405.jpg", "Starting the trail" %}

{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3407.jpg", "Coastal path in the morning" %}
...
{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3413.jpg", "Sandy trail along the coast" %}

{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3422.jpg", "Coastal cliffs" %}

{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3447.jpg", "Ocean views" %}
...
{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3440.jpg", "Walking through the heat" %}
...
{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3460.jpg", "Rocky coastline" %}

{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3458.jpg", "Trail along the cliffs" %}
...
{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3469.jpg", "Approaching Zambujeira do Mar" %}
...
{% image "https://pub-b61096e0d85d4ca4b13ec99471178910.r2.dev/field-notes/fishermans-trail-day3/DSCF3482.jpg", "Evening view of Zambujeira do Mar" %}
